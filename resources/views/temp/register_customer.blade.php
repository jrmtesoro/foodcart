        ...
        <div class="mx-auto col-sm-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Customer Register</h4>
                </div>
                <div class="card-body">
                    <form class="form" role="form" method="POST" action={{route('register.customer')}}>
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="email" name="reg_email" value="rytesoro7@gmail.com">
                            </div>
                        </div>
                        <div class="form-group row">
