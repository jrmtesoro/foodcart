...
{{-- Page Name --}}
@section('page-name', 'Menu / View Item')
                    ...
                    <div class="card shadow">
                        <div class="card-header bg-white">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <a class="btn btn-outline-warning btn-sm" href="{{ route('menu.edit', ['menu' => $menu_details['id']]) }}"><span class='fas fa-pencil-alt py-1'></span></a>
                                    <button class="btn btn-outline-danger btn-sm" data-toggle="modal" data-menu="{{ $menu_details['id'] }}" 
                                    data-target="#delete_confirmation"><span class='fas fa-minus-circle py-1' style="font-size: 1rem;"></span></button>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 col-md-6 col-sm-5">
                                    <p class="font-weight-bold">{{$menu_details['category'][0]['name'] ?? '-'}}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
