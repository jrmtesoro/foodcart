...
{{-- Page Name --}}
@section('page-name', 'Customers / Order / View Order')
                ...
                <div class="card shadow bg-secondary">
                    <div class="card-header">
                        <div class="d-flex">
                            ...
                            <a class="btn btn-primary" href="{{ route('customer.show', ['customer_id' => $customer_id]) }}"><span class='fas fa-arrow-left mr-1'></span> Go Back</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
